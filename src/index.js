import { resolveResourceRelativePathBySourcePath } from "./lib/route/index.js";
import {
  createVariable,
  createObjectExpression,
  resolveMemberExpressionPropertyName,
} from "./lib/babel-helpers/index.js";
import { getCSSModulesTokens } from "./lib/css-modules-tokens/index.js";

export default function babelPluginTransformCssModules(babelAPI) {
  /**
        ...
        switch (resolvedTokenKey) {
          ...
          default: {
            ...
            if (className) {
              ...
              console.warn(
                `[babel-plugin-transform-modules-css]: token key not found. See '${resolvedTokenKey}' of ${sourcePath}.`
              );
            }
          }
        }
